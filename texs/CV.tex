...
\newcommand{\CVAuthor}{Haoren Zheng}
\newcommand{\CVTitle}{Curriculum Vitae -- Haoren Zheng}
\newcommand{\CVNote}{Last updated on {\today}}
\newcommand{\CVWebpage}{https://puzhre.github.io/}
...
\begin{SubTitle}
\href{https://www.google.com/maps/place/800+Dongchuan+Road,+Minhang+District,+Shanghai}
{800 Dongchuan Road, Minhang District, Shanghai 200240, P.R. China}
\par
Shanghai Jiao Tong University (Minhang Campus)
\par
\href{mailto:zhenghaoren@sjtu.edu.cn}
{zhenghaoren@sjtu.edu.cn}
\,\SubBulletSymbol\,
+86-18357901386
\,\SubBulletSymbol\,
\href{\CVWebpage}
...
\Entry
{\textbf{Nanjing University of Science and Technology}},
Nanjing, China

\Gap
\BulletItem
B.S. in Information and Computational Science (Mathematics),\\
minor in Artificial Intelligence (double degree)
\hfill
\DatestampYM{2021}{09} --
\DatestampYM{2025}{06}
\begin{Detail}
...
GPA: 3.85 / 4.0.
\SubBulletItem
Supervisor: Prof.~Hongyi~Liu.
\SubBulletItem
Research: Remote Sensing Image Unmixing
\end{Detail}


\BigGap
\Entry
{\textbf{Global College, Shanghai Jiao Tong University}},
Shanghai, China
...
\begin{Detail}
\SubBulletItem
Adviser: Prof.~Dezhi~Zhou.
\SubBulletItem
Current direction: foundation model for integrated simulation--optimization--design in combustion dynamical systems (advised by Prof.~Dezhi~Zhou and Prof.~Tailin~Wu).
\end{Detail}
...
% \Gap
% \BulletItem
% Undergraduate research: Remote Sensing Image Unmixing
% \hfill
% \DatestampYM{2022}{09} --
% \DatestampYM{2024}{06}
% \begin{Detail}
...
% \BigGap
\Entry
{\textbf{AI Industry Research (AIR), Tsinghua University}},
Beijing, China
...
\SubBulletItem
Research: AIGC theory and application
\end{Detail}

\BigGap
\Entry
{\textbf{School of Engineering, Westlake University}},
Hangzhou, China
...
\begin{Detail}
\SubBulletItem
Supervisor: Prof.~Tailin~Wu; Co-supervisor: Prof.~Long~Wei.
\SubBulletItem
Research: AI for Science \& Science for AI
\end{Detail}

% \BigGap
% \Entry
% {\textbf{Global College, Shanghai Jiao Tong University (SJTU)}},
% Shanghai, China
...
\begingroup
\renewcommand{\MaxNumberedItem}{[6]}

\BigGap

\NumberedItem{[1]}
\underline{Haoren Zheng}, Zulong Li, Chenyu Sun, Hanqiu Zhang, Hongyi Liu, Zhihui Wei.
``Blind unmixing using dispersion model-based autoencoder to address spectral variability.''
\textit{IEEE Transactions on Geoscience and Remote Sensing (TGRS)}, 2024.
(\href{https://ieeexplore.ieee.org/document/10526310}{Paper};
\href{https://github.com/Puzhre/DMTS-Net}{Code})

\Gap
\NumberedItem{[2]}
Haodong Feng*, \underline{Haoren Zheng*}, Peiyan Hu, Hongyuan Liu, Chenglei Yu, Long Wei, Ruiqi Feng, Jinlong Duan, Dixia Fan, Tailin Wu.
``FluidZero: Mastering Diverse Tasks in Fluid Systems through a Single Generative Model.''
Submitted to \textit{Physical Review X Intelligence}, 2026.
(\href{https://assets-eu.researchsquare.com/files/rs-6881567/v1/63e5e81e0d8b6c9944a0c58d.pdf}{Paper};
\href{https://github.com/AI4Science-WestlakeU/FluidZero}{Code})

\Gap
\NumberedItem{[3]}
Peiyan Hu*, Haodong Feng*, Hongyuan Liu*, Tongtong Yan, Wenhao Deng, Tianrun Gao, Rong Zheng, \underline{Haoren Zheng}, Chenglei Yu, Chuanrui Wang, Kaiwen Li, Zhi-Ming Ma, Dezhi Zhou, Xingcai Lu, Dixia Fan, Tailin Wu.
``RealPDEBench: A Benchmark for Complex Physical Systems with Real-World Data.''
Accepted at the \textit{International Conference on Learning Representations (ICLR)}, 2026 (oral presentation).
(\href{https://arxiv.org/abs/2601.01829v1}{Paper};
\href{https://github.com/AI4Science-WestlakeU/RealPDEBench}{Code};
\href{https://realpdebench.github.io/}{Project})

\Gap
\NumberedItem{[4]}
Tianrun Gao*, \underline{Haoren Zheng*}, Wenhao Deng*, Haodong Feng, Tao Zhang, Ruiqi Feng, Qianyi Chen, Tailin Wu.
``GenCP: Towards Generative Modeling Paradigm of Coupled Physics with Application to Fluid-Structure Interaction.''
Accepted at the \textit{International Conference on Learning Representations (ICLR)}, 2026 (poster).
(\href{https://arxiv.org/abs/2601.19541}{Paper};
\href{https://github.com/AI4Science-WestlakeU/GenCP}{Code})

\Gap
\NumberedItem{[5]}
Tian Bu*, Chuanrui Wang*, Hao Ma, \underline{Haoren Zheng}, Xin Lu, Tailin Wu.
``GGBall: Graph Generative Model on Poincar\'e Ball.''
Accepted at the \textit{International Conference on Learning Representations (ICLR)}, 2026 (poster).
(\href{https://arxiv.org/abs/2506.07198}{Paper};
\href{https://github.com/AI4Science-WestlakeU/GGBall}{Code})

\Gap
\NumberedItem{[6]}
\underline{Haoren Zheng}, Shibo Gu, Evatt R.~Hawkes, Dezhi Zhou, Xingcai Lu.
``Generate reacting flow fields with flow matching neural operators on high-resolution grids.''
Accepted to the 41st International Symposium on Combustion (ISOC), 2026 (poster).
...
\BulletItem
Jinhua ``Five-Good Student''.
\hfill
\DatestampY{2020}

\Gap
\BulletItem
Annual Outstanding Athlete, Nanjing University of Science and Technology.
\hfill
\DatestampY{2022}

\Gap
\BulletItem
Meritorious Winner, Mathematical Contest in Modeling / Interdisciplinary Contest in Modeling (MCM/ICM).
\hfill
\DatestampY{2024}
...
\Entry
Python, C++, PyTorch, Git, Linux, \LaTeX

\Section
{Service \& Leadership}
{Service \& Leadership}
{PDF: ServiceLeadership}

\BulletItem
Research mentorship: led a hyperspectral image unmixing research project, \\ mentoring 3 junior students.
\hfill
\DatestampYM{2024}{09} --
\DatestampYM{2025}{06}
...
\Gap
\BulletItem
Research mentorship: led an AI-for-combustion control research project, \\ mentoring 3 senior undergraduates.
\hfill
\DatestampYM{2025}{11} --
Present
...
\Entry
Fitness, Cycling, Go (Weiqi) (Amateur 4-dan), Rubik's Cubes
